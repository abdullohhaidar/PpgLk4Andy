  ...
  return (
    ...
    >
      <div
        ...
        className="p-4 xs:p-8 bg-white hover:shadow-xl h-auto shadow-gray-300 ease-out duration-800 rounded-lg my-6 flex relative overflow-hidden cursor-pointer"
      >
        <p
